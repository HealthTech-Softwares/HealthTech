        ...
        <form>
          <div className="row m-2">
            <div className="col-12">
              <LabelMbTres
                propiedad="Nombre del titular"
                ejemplo="Juan Perez"
              />
              <LabelMbTres
                propiedad="Número de tarjeta"
                ejemplo="@example.com"
              />
              <LabelMbTres
                propiedad="Fecha de vencimiento (MM/YYYY)"
                ejemplo="1111 - 1111 - 1111 - 1111"
              />
              <LabelMbTres
                propiedad="Código de seguridad (CVV)"
                ejemplo="111"
              />
            </div>
          </div>
