...
export function FormInicioSesion({ error, onSubmit, register, errors }) {
  return (
    <div className="col-6">
      ...
      <form className="row g-3 d-flex flex-column align-items-center" onSubmit={onSubmit}>
        <div className="col-6">
        ...
        <div className="col-6">
          ...
          { errors.contrasenia && <p className="text-danger">Constraseña es requerida</p> }
        </div>
        <div className="col-6">
          <label htmlFor="inputPassword4" className="form-label">
            ¿No tiene una cuenta?
  ...
  return (
    <div className={`container-fluid ${styles.containerFluid}`}>
      <div className="row align-items-center justify-content-center vh-100">
        ...
        <FormInicioSesion error={error} onSubmit={onSubmit} register={register} errors={errors} />
      </div>
    </div>
  );
}
